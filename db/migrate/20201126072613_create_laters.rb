class CreateLaters < ActiveRecord::Migration[6.0]
  def change
    create_table :laters do |t|
      t.string :start_at_hour_top, null: :false
      t.string :start_at_minute_top, null: :false
      t.string :start_at_hour_bottom, null: :false
      t.string :start_at_minute_bottom, null: :false
